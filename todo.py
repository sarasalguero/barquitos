...
esloras_demo = [2]
esloras_reales = [1,1,1,1,2,2,2,3,3,4]
...
def jugar_hundir_la_flota():
    ...
    while True:
        mostrar_tableros(tablero_connor, tablero_terminator_original, tablero_terminator_reflejo)
        disparar_connor(tablero_connor, tablero_terminator_original, vidas_connor, vidas_terminator)
